...
from setup_hbase import check_hbase, run_hbase_setup  # noqa: E402
from setup_kafka import check_kafka, run_kafka_setup  # noqa: E402
from setup_nifi import check_nifi, set_nifi_variables, upload_nifi_template  # noqa: E402
...
def setup_hdfs_directories():
    ...
    directories = ["/user/archive", "/user/spark"]
